"""
Joint permutation importance for the developed-land cluster (DT, DM, DO).

Why this exists
---------------
Single-feature permutation importance is misleading under perfect rank
deficiency. In the training data, DT = DM + DO exactly (R^2 = 1.000), so when we
...
This script:
  1. Loads the production model + test split.
