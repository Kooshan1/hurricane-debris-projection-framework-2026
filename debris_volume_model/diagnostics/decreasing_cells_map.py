...
def make_map(storm: str):
    p20 = gpd.read_file(PRED_DIR / storm / "2020" / "debris_volume_predictions.shp")
    p40 = gpd.read_file(PRED_DIR / storm / "2040" / "debris_volume_predictions.shp")
    ...
    cb.set_label(f"ΔDebris (2040 − 2020) [m³ / 250 m cell]   |   "
